...
var DTS = DTS || {
	...
	// -------------------------------------------------------------------------------------------
	loadData: function (isDateTimeOnly) {
		DTS.isLoading = true;
		$.ajax({
			type: "GET",
	...
	// -------------------------------------------------------------------------------------------
	loadFromJson: function (json, isDateTimeOnly) {
	...
	// -------------------------------------------------------------------------------------------
	loadTimeZoneListCombobox: function () {
		$.ajax({
			type: "GET",
	...
	// -------------------------------------------------------------------------------------------
	loadTimeZoneListComboboxFromData: function (json) {
	...
	// -------------------------------------------------------------------------------------------
	loadInternetTimeServerCombobox: function () {
		$.ajax({
			type: "GET",
	...
	// -------------------------------------------------------------------------------------------
	loadInternetTimeServerComboboxFromData: function (json) {
	...
	// -------------------------------------------------------------------------------------------
	loadRefreshUnitsCombobox: function () {
		$.ajax({
			type: "GET",
	...
	// -------------------------------------------------------------------------------------------
	loadRefreshUnitsComboboxFromData: function (xml) {
	...
	// -------------------------------------------------------------------------------------------
	syncWithMyClock: function (sender) {
		if (sender.checked) {
	...
	// -------------------------------------------------------------------------------------------
	syncWithInternet: function (sender) {
	...
	// -------------------------------------------------------------------------------------------
	enableMachineTimeZone: function (isEnabled) {
	...
	// is true or false.
	// -------------------------------------------------------------------------------------------
	enableDatetimePicker: function (isEnabled) {
		var isAdminLevel = CMN.isAdminLevel();
		if (!isEnabled)
	...
	// -------------------------------------------------------------------------------------------
	timeToMilliseconds: function (time, units) {
	...
	// -------------------------------------------------------------------------------------------
	getBrowserTimeZoneIndex: function () {
